...
def test_fit_predict():
    ...
    print("Values of your_variable for Logistic Regression:", modelLR.theta)
    print("Values of expected_array for Non Linear Logistic Regression:", expected_array_nlr)
    print("Values of your_variable for Non Linear Logistic Regression:", modelNLR.theta)    
    
    # Define a tolerance for floating-point comparison
    tolerance = 0.4  # Adjust tolerance as needed

    # Perform a tolerance-based comparison
    comparison_lr = np.abs(modelLR.theta - expected_array_lr) < tolerance
    comparison_nlr = np.abs(modelNLR.theta - expected_array_nlr) < tolerance
