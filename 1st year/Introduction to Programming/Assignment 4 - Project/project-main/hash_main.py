...
names = ["Ella", "Owen", "Fred", "Zoe", "Adam", "Ceve", "Adam",
         "Ceve", "Jonas", "Ola", "Morgan", "Fredrik", "Simon",
         "Albin", "Jonas", "Amer", "David"]
for name in names:
    words.add(name)

print("\nto_string():", words.to_string())
# { Adam David Amer Ceve Owen Ella Jonas Morgan
# Fredrik Zoe Fred Albin Ola Simon }
print("get_size():", words.get_size())
# 14
...
for s in delete:
    words.remove(s)
print("\nget_size:", words.get_size())
# 10
print("to_string():", words.to_string())
# { David Amer Owen Ella Morgan Fredrik Zoe Fred Albin Simon }
